  ...
  return (
    <div className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]">
            ...
            return (
              <button
                ...
                className={cx(
                  ...
                  (hasActivity || hasDeadline || hasFocus) && day.inMonth && !isSelected && "border-moss-500/75 ring-1 ring-moss-300/60 dark:border-moss-300/60 dark:ring-moss-700/50",
      ...
      <Panel>
        ...
        <section className="mt-5 rounded-xl border border-ink-200/85 bg-white/62 p-4 dark:border-white/10 dark:bg-white/[0.04]">
